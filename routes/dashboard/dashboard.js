...
var dashboard_02_SI = require('../../mock/V00/dashboard/dashboard/dashboard_03.SI.json');
...
router.get('/V00/dashboard', function(req, res, next) {
    ...
    if ((tsec == 'null' || tsec == '') && req.query.$filter === 'productType==TT' )
	   return res.json(dashboard_02);
        ...
        return res.json(dashboard_02_SI);
    else if ((tsec == 'null' || tsec != undefined || tsec == '') && req.query.$filter === 'productType==SI,idContract==SIMXP0000002')
